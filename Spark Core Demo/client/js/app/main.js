...
$(document).ready(function() {
	$(function () {
		$('#datetimepicker1').datepicker('update', new Date()).on('changeDate', function( e ) {
			...
			$.getJSON('http://dev.naustud.io:3000/temperature/' + selectedDate,function(data) {
				console.log(data);
	...
	// Get Temperature
	$.getJSON('http://dev.naustud.io:3000/temperature',function(data) {
	...
	// Get Motions
	$.getJSON('http://dev.naustud.io:3000/date/',function(data) {
		//Motion code here
		var html = '';
		var i;
